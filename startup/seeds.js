  ...
  const shelves = [
    {
      name: "Shelf One",
      description:
        "Description of shelf one, which contains some items and is super cool and all that.",
    ...
    {
      name:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam mattis quam sit amet enim rutrum, tincidunt convallis mi ullamcorp",
      description:
...
async function seedItems() {
  ...
  const otherCat = await Category.findOne({ name: "Other" });
  const watchCat = await Category.findOne({ name: "Watches" });
  const testShelf = await Shelf.findOne({
    name:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam mattis quam sit amet enim rutrum, tincidunt convallis mi ullamcorp"
  });
