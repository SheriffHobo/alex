		...
		<main className="valign-wrapper newshelf">
			<center>
				<form className="valign-wrapper newshelfform" method="post">
					<div className="row">
						custom category categoryName (or subcategory, click to populate)
						<div className="input-field">
							...
							/>
							<label for="shelfname">Name your shelf</label>
						</div>
						<div className="input-field">
							<input
								type="text"
							...
							/>
							<label for="shelfdesc">Describe your shelf</label>
						</div>
						<div className="input-field">
							<input
								type="text"
							...
							/>
							<label for="shelfcatname">Select a subcategory below or type one in</label>
						</div>
						<div className="input-field">
							<input
								type="text"
							...
							/>
							<label for="shelfcatname">Choose a custom category</label>
						</div>
						<button
							type="submit"
